...
@DisplayName("API тесты получения данных пользователей")
@Epic("Пользователи")
...
public class GetUsersTests {
    ...
    void getUsersWithPaginationTest() {
        ...
        step("Валидация структуры пагинации", () -> assertAll("Проверка данных пагинации",
    ...
    @DisplayName("Получение пользователей по идентификатору")
    ...
    void getUserByIdParameterizedTest(int userId, String expectedFirstName, String expectedLastName) {
        ...
        step(String.format("Валидация данных пользователя ID: %d", userId), () -> assertAll("Проверка данных пользователя",
    ...
    void getFirstPageUsersTest() {
        ...
        step("Валидация данных первой страницы", () -> assertAll("Проверка первой страницы",
